                    ...
                    <Row className="row-main">
                            ...
                            <div className="div-left">
                                <Container className="container-left">
                                    <Row className="row-text">
                                        <Carousel transitionMs={1000} enableSwipe={false} enableMouseSwipe={false} itemsToShow={1} itemsToScroll={1} enableSwipe={true} verticalMode={true} showArrows={false} pagination={false} ref={ref => (this.carouselText = ref)}>
                                    ...
                                    <Carousel transitionMs={1000} enableSwipe={false} enableMouseSwipe={false} itemsToShow={1} itemsToScroll={1} enableSwipe={true} verticalMode={true} showArrows={false} pagination={false} ref={ref => (this.carouselStats = ref)}>
                        ...
                        <Col className="col-std col-right" md={5}>
                            <div className="div-right">
                                <Carousel transitionMs={200} enableSwipe={false} enableMouseSwipe={false} itemsToShow={1} itemsToScroll={1} enableSwipe={true} verticalMode={true} showArrows={false} pagination={false} ref={ref => (this.carouselPic = ref)}>
